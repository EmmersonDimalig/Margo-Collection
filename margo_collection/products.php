            ...
            foreach ($products as $product): ?>
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <button class="checkout-btn" data-price="<?= $product['price'] ?>" data-name="<?= htmlspecialchars($product['name']) ?>" data-image="<?= htmlspecialchars($product['image_url']) ?>">Add to cart</button>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
